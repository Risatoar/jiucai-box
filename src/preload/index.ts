...
const api: DesktopApi = {
  ...
  getReviewReport: (request) => ipcRenderer.invoke('review:get', request),
  refreshReviewReport: (request) => ipcRenderer.invoke('review:refresh', request),
  saveReviewRating: (period, tradingDate, input) => ipcRenderer.invoke('review:rating', period, tradingDate, input),  analyzePositionStrategy: (request) => ipcRenderer.invoke('ai:position-strategy', request),
  ...
  listCodexModels: (codexPath) => ipcRenderer.invoke('ai:codex-models:list', codexPath),
  ...
  loadSignalHistory: (code) => ipcRenderer.invoke('signals:history', code),
  reviewSignals: (tradingDate) => ipcRenderer.invoke('signals:review', tradingDate),
