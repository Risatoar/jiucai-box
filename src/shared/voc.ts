...
export const defaultVocSources: VocSource[] = [
  ...
  { id: 'douyin-xiaozhang-chifan-yonggang', platform: 'douyin', displayName: '小张小张吃饭用缸', handle: '小张小张吃饭用缸', profileUrl: 'https://www.douyin.com/user/MS4wLjABAAAA_sHkSUBr1cape7_GRcft0iyjIy_FI6LbMISErXTyc7FHf6xaHe-bWo8pwX1eJ4Kx?from_tab_name=main', enabled: true, inverseWeight: 0.8, status: 'needs_connector' }
]
